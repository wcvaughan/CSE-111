...
def main():
    ...
    sentence = make_sentence(1, "past", word, noun, verb)
    print(sentence)
    word = get_determiner(1)
    noun = get_noun(1)
    verb = get_verb(1, "present")
    sentence = make_sentence(1, "present", word, noun, verb)
    print(sentence)
    word = get_determiner(1)
    noun = get_noun(1)
    verb = get_verb(1, "future")
    sentence = make_sentence(1, "future", word, noun, verb)
    print(sentence)
    word = get_determiner(2)
    noun = get_noun(2)
    verb = get_verb(2, "past")
    sentence = make_sentence(2, "past", word, noun, verb)
    print(sentence)
    word = get_determiner(2)
    noun = get_noun(2)
    verb = get_verb(2, "present")
    sentence = make_sentence(2, "present", word, noun, verb)
    print(sentence)
    word = get_determiner(2)
    noun = get_noun(2)
    verb = get_verb(2, "future")
    sentence = make_sentence(2, "future", word, noun, verb)
    print(sentence)
...
def make_sentence(quantity, tense, word, noun, verb):
